...
max_iterations = configParser.get('train_param', 'max_iterations')
style_weight = configParser.get('train_para', 'style_weight')
content_weight = configParser.get('train_param', 'content_weight')
